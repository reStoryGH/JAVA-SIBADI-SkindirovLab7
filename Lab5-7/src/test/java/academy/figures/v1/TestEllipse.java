...
public class TestEllipse {
    ...
    public void testIsPointInsideEllipse1() {
        ...
        assertAll(
                ...
                () -> assertTrue(ellipse.isInside(10, 25)),
                ...
                () -> assertFalse(ellipse.isInside(25, 20)),
                () -> assertFalse(ellipse.isInside(10, 50)),
                () -> assertFalse(ellipse.isInside(-5, 20))  
        );
    }
    ...
    public void testIsPointInsideEllipse2() {
        ...
        assertAll(
                ...
                () -> assertFalse(ellipse.isInside(new Point(25, 20))),
                () -> assertFalse(ellipse.isInside(new Point(10, 50))),
                () -> assertFalse(ellipse.isInside(new Point(-5, 20)))
        );
    }
